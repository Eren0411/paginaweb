...
class Paquetes extends Conectar
{
    private $table;
    private $view;
    private $id;
    ...
    public function updatePaquete($value)
    {
        try {
    ...
    public function deletePaquete($value)
    {
        $this->id = $value;
    ...
    public function deletePaqueteWhereSistema($IdSistema){ //función para borrar las funciones junto con el sistema
